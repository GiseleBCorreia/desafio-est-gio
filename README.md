...
5. Na aba **Transferência** *-, informe o ID de duas contas e um valor - a operação debita da origem (com tarifa, se for corrente) e credita o valor na conta destino, retornando os nomes dos titulares envolvidos, o valor transferido, a tarifa e o valor total debitado.
